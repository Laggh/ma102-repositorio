...
PESO_MEDIA_VALOR_PADRAO = peso_atual("PESO_MEDIA_VALOR_PADRAO")

# Pesos da avaliacao quando a mao tem manilha. (somam 1.0)
PESO_CHANCE_MANILHA = peso_atual("PESO_CHANCE_MANILHA")
PESO_VALOR_MANILHA = peso_atual("PESO_VALOR_MANILHA")

# Pesos de bonus para a avaliacao da mao quando tem manilha
BONUS_QTD_MANILHAS = peso_atual("BONUS_QTD_MANILHAS")
BONUS_MELHOR_MANILHA = peso_atual("BONUS_MELHOR_MANILHA")

# Ajustes por quantidade de cartas na mao.
MULTIPLICADOR_MAO_MANILHA_3 = peso_atual("MULTIPLICADOR_MAO_MANILHA_3")
MULTIPLICADOR_MAO_BASE_2 = peso_atual("MULTIPLICADOR_MAO_BASE_2")
MULTIPLICADOR_VENCEU_PRIMEIRA_RODADA = peso_atual("MULTIPLICADOR_VENCEU_PRIMEIRA_RODADA")
MULTIPLICADOR_PERDEU_PRIMEIRA_RODADA = peso_atual("MULTIPLICADOR_PERDEU_PRIMEIRA_RODADA")

RDD2_LIMIAR_SUBSTITUIR_CARTA = peso_atual("RDD2_LIMIAR_SUBSTITUIR_CARTA")
RDD2_LIMIAR_PEDIR_TRUCO = peso_atual("RDD2_LIMIAR_PEDIR_TRUCO")

# Terceira rodada: a decisão principal é se a única carta vale um truco.
RDD3_LIMIAR_PEDIR_TRUCO = peso_atual("RDD3_LIMIAR_PEDIR_TRUCO")

# Resposta a truco: quando correr, aceitar ou aumentar.
RESP_LIMIAR_CORRER = peso_atual("RESP_LIMIAR_CORRER")
RESP_LIMIAR_AUMENTAR = peso_atual("RESP_LIMIAR_AUMENTAR")
